...
public class CheckoutPageInvalidSingularInputFormat extends BasePage{
    ...
    //invalid guest account generated data (shipping address) - invalid singular input format
    private String invalidGuestShipAccFirstNameFormat;
    private String invalidGuestShipAccLastNameFormat;
    private String invalidGuestShipAccAddress1Format;
    private String invalidGuestShipAccCityFormat;
    private String invalidGuestShipAccPostCodeFormat;
    ...
    //invalid guest account input data getter (billing and shipping address) - invalid shipping first name format (special symbols only)
    public void invalidGuestAccountInputDataInvalidShipFirstNameFormatGetter(){
        ...
        invalidGuestShipAccFirstNameFormat = "#%$#$%^$^";
        validGuestShipAccLastName = validGuestAccLastName;
        validGuestShipAccAddress1 = TestDataGenerator.generateRandomAddress(4);
        validGuestShipAccCity = TestDataGenerator.getRandomCity();
        validGuestShipAccPostCode = TestDataGenerator.getRandomPostalCode();

        System.out.println("Generated input data for valid guest account (invalid shipping first name format): " + "\n");

        logger.info("Valid guest first name (invalid shipping first name format): " + validGuestAccFirstName);
        logger.info("Valid guest last name (invalid shipping first name format): " + validGuestAccLastName);
        logger.info("Valid guest address1 (invalid shipping first name format): " + validGuestAccAddress1);
        logger.info("Valid guest city (invalid shipping first name format): " + validGuestAccCity);
        logger.info("Valid guest post code (invalid shipping first name format): " + validGuestAccPostCode);
        logger.info("Valid guest email (invalid shipping first name format): " + validGuestAccEmail);

        logger.info("Invalid guest (shipping address section) first name format: " + invalidGuestShipAccFirstNameFormat);
        logger.info("Valid guest (shipping address section) last name (invalid shipping first name format): " + validGuestShipAccLastName);
        logger.info("Valid guest (shipping address section) address1 (invalid shipping first name format): " + validGuestShipAccAddress1);
        logger.info("Valid guest (shipping address section) city (invalid shipping first name format): " + validGuestShipAccCity);
        logger.info("Valid guest (shipping address section) post code (invalid shipping first name format): " + validGuestShipAccPostCode);

        System.out.println("\n");

    }

    //invalid guest account input data getter (billing and shipping address) - invalid shipping last name format (special symbols only)
    public void invalidGuestAccountInputDataInvalidShipLastNameFormatGetter(){
        ...
        validGuestShipAccFirstName = validGuestAccFirstName;
        invalidGuestShipAccLastNameFormat = "#$%$#^%$";
        validGuestShipAccAddress1 = TestDataGenerator.generateRandomAddress(4);
        validGuestShipAccCity = TestDataGenerator.getRandomCity();
        validGuestShipAccPostCode = TestDataGenerator.getRandomPostalCode();

        System.out.println("Generated input data for valid guest account (invalid shipping last name format): " + "\n");

        logger.info("Valid guest first name (invalid shipping last name format): " + validGuestAccFirstName);
        logger.info("Valid guest last name (invalid shipping last name format): " + validGuestAccLastName);
        logger.info("Valid guest address1 (invalid shipping last name format): " + validGuestAccAddress1);
        logger.info("Valid guest city (invalid shipping last name format): " + validGuestAccCity);
        logger.info("Valid guest post code (invalid shipping last name format): " + validGuestAccPostCode);
        logger.info("Valid guest email (invalid shipping last name format): " + validGuestAccEmail);

        logger.info("Valid guest (shipping address section) first name (invalid shipping last name format): " + validGuestShipAccFirstName);
        logger.info("Invalid guest (shipping address section) last name format: " + invalidGuestShipAccLastNameFormat);
        logger.info("Valid guest (shipping address section) address1 (invalid shipping last name format): " + validGuestShipAccAddress1);
        logger.info("Valid guest (shipping address section) city (invalid shipping last name format): " + validGuestShipAccCity);
        logger.info("Valid guest (shipping address section) post code (invalid shipping last name format): " + validGuestShipAccPostCode);

        System.out.println("\n");

    }

    //invalid guest account input data getter (billing and shipping address) - invalid shipping address format (special symbols only)
    public void invalidGuestAccountInputDataInvalidShipAddressFormatGetter(){
        ...
        validGuestShipAccFirstName = validGuestAccFirstName;
        validGuestShipAccLastName = validGuestAccLastName;
        invalidGuestShipAccAddress1Format = "@$@#$%$#^$%";
        validGuestShipAccCity = TestDataGenerator.getRandomCity();
        validGuestShipAccPostCode = TestDataGenerator.getRandomPostalCode();

        System.out.println("Generated input data for valid guest account (invalid shipping address format): " + "\n");

        logger.info("Valid guest first name (invalid shipping address format): " + validGuestAccFirstName);
        logger.info("Valid guest last name (invalid shipping address format): " + validGuestAccLastName);
        logger.info("Valid guest address1 (invalid shipping address format): " + validGuestAccAddress1);
        logger.info("Valid guest city (invalid shipping address format): " + validGuestAccCity);
        logger.info("Valid guest post code (invalid shipping address format): " + validGuestAccPostCode);
        logger.info("Valid guest email (invalid shipping address format): " + validGuestAccEmail);

        logger.info("Valid guest (shipping address section) first name (invalid shipping address format): " + validGuestShipAccFirstName);
        logger.info("Valid guest (shipping address section) last name (invalid shipping address format): " + validGuestShipAccLastName);
        logger.info("Invalid guest (shipping address section) address1 format: " + invalidGuestShipAccAddress1Format);
        logger.info("Valid guest (shipping address section) city (invalid shipping address format): " + validGuestShipAccCity);
        logger.info("Valid guest (shipping address section) post code (invalid shipping address format): " + validGuestShipAccPostCode);

        System.out.println("\n");

    }

    //invalid guest account input data getter (billing and shipping address) - invalid shipping city format (special symbols only)
    public void invalidGuestAccountInputDataInvalidShipCityFormatGetter(){
        ...
        validGuestShipAccFirstName = validGuestAccFirstName;
        validGuestShipAccLastName = validGuestAccLastName;
        validGuestShipAccAddress1 = TestDataGenerator.generateRandomAddress(8);
        invalidGuestShipAccCityFormat = "$#$^%&^%^";
        validGuestShipAccPostCode = TestDataGenerator.getRandomPostalCode();

        System.out.println("Generated input data for valid guest account (invalid shipping city format): " + "\n");

        logger.info("Valid guest first name (invalid shipping city format): " + validGuestAccFirstName);
        logger.info("Valid guest last name (invalid shipping city format): " + validGuestAccLastName);
        logger.info("Valid guest address1 (invalid shipping city format): " + validGuestAccAddress1);
        logger.info("Valid guest city (invalid shipping city format): " + validGuestAccCity);
        logger.info("Valid guest post code (invalid shipping city format): " + validGuestAccPostCode);
        logger.info("Valid guest email (invalid shipping city format): " + validGuestAccEmail);

        logger.info("Valid guest (shipping address section) first name (invalid shipping city format): " + validGuestShipAccFirstName);
        logger.info("Valid guest (shipping address section) last name (invalid shipping city format): " + validGuestShipAccLastName);
        logger.info("Valid guest (shipping address section) address1 (invalid shipping city format): " + validGuestShipAccAddress1);
        logger.info("Invalid guest (shipping address section) city format: " + invalidGuestShipAccCityFormat);
        logger.info("Valid guest (shipping address section) post code (invalid shipping city format): " + validGuestShipAccPostCode);

        System.out.println("\n");

    }

    //invalid guest account input data getter (billing and shipping address) - invalid shipping post code format (special symbols only)
    public void invalidGuestAccountInputDataInvalidShipPostCodeFormatGetter(){
        ...
        validGuestShipAccAddress1 = TestDataGenerator.generateRandomAddress(8);
        validGuestShipAccCity = TestDataGenerator.getRandomCity();
        invalidGuestShipAccPostCodeFormat = "#@#$@#$@";

        System.out.println("Generated input data for valid guest account (invalid shipping post code format): " + "\n");

        logger.info("Valid guest first name (invalid shipping post code format): " + validGuestAccFirstName);
        logger.info("Valid guest last name (invalid shipping post code format): " + validGuestAccLastName);
        logger.info("Valid guest address1 (invalid shipping post code format): " + validGuestAccAddress1);
        logger.info("Valid guest city (invalid shipping post code format): " + validGuestAccCity);
        logger.info("Valid guest post code (invalid shipping post code format): " + validGuestAccPostCode);
        logger.info("Valid guest email (invalid shipping post code format): " + validGuestAccEmail);

        logger.info("Valid guest (shipping address section) first name (invalid shipping post code format): " + validGuestShipAccFirstName);
        logger.info("Valid guest (shipping address section) last name (invalid shipping post code format): " + validGuestShipAccLastName);
        logger.info("Valid guest (shipping address section) address1 (invalid shipping post code format): " + validGuestShipAccAddress1);
        logger.info("Valid guest (shipping address section) city (invalid shipping post code format): " + validGuestShipAccCity);
        logger.info("Invalid guest (shipping address section) post code format: " + invalidGuestShipAccPostCodeFormat);
    ...
    //invalid guest data input methods (shipping address) - invalid singular input format
    public void inputInvalidGuestShipFirstNameFormatIntoFirstNameInputField(){checkoutPageNameShipAddressFirstNameInputField.sendKeys(invalidGuestShipAccFirstNameFormat);}
    public void inputInvalidGuestShipLastNameFormatIntoLastNameInputField(){checkoutPageNameShipAddressLastNameInputField.sendKeys(invalidGuestShipAccLastNameFormat);}

    public void inputInvalidGuestShipAddress1FormatIntoAddress1InputField(){
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", checkoutPageNameAddressShipDiffAddressCheckbox);
        checkoutPageNameShipAddressAddress1InputField.sendKeys(invalidGuestShipAccAddress1Format);
    }

    public void inputInvalidGuestShipCityFormatIntoCityInputField(){checkoutPageNameShipAddressCityInputField.sendKeys(invalidGuestShipAccCityFormat);}
    public void inputInvalidGuestShipPostCodeFormatIntoPostCodeInputField(){checkoutPageNameShipAddressPostCodeInputField.sendKeys(invalidGuestShipAccPostCodeFormat);}
