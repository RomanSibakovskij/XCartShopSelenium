...
public class HomePageTest extends TestMethods {
    ...
    //Test 007g -> add multiple searched product ("R/C Desktop Forklift") to cart test (as a registered user)
    @Test
    @DisplayName("Multiple Searched Product Addition To Cart Test (as a registered user)")
    @Tag("Add_Multiple_Searched_Products_To_Cart")
    @Tag("Test_As_A_Reg_User")
    void multipleSearchedProductRegUserAddToCartTest() {
        RegisterPage registerPage = new RegisterPage(driver);
        //navigate user to 'Register' page test
        navigateToRegisterPageTest();
        //valid user account creation test
